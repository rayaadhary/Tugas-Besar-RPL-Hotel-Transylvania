...
<div class="border-end bg-white" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush">
        <a href="../pelanggan/pelanggan-view.php" class="list-group-item list-group-item-action list-group-item-light p-3 <?php if ($_SESSION["current_page"] == "Pelanggan") { echo "active"; } else { echo "inactive"; } ?>"><span><i class="fa fa-user"></i> Lihat Profil</span></a>
